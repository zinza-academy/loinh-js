...
import { LoginUserDto, RegisterUserDto, ResetPasswordWithTokenDto } from '@dto/auth/auth.dto';
...
export class AuthController {
  ...
  async resetPasswordWithCode(
    ...
    return (
      this.authService.verifyResetPasswordCode(verifyResetPasswordCodeDto)
    );
  }
